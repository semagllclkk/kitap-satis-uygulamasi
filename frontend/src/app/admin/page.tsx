            ...
            <main className="page" style={{ flex: 1, paddingBottom: '4rem' }}>
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="card" style={{ padding: '1.5rem', marginBottom: '2rem' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
                                <h2 style={{ fontSize: '1.1rem', fontWeight: '700', color: '#c084fc' }}>📝 Son Siparişler</h2>
                            </div>
                            <div style={{ overflowX: 'auto', maxHeight: '400px' }}>
                                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                                    <thead style={{ position: 'sticky', top: 0, background: 'var(--color-surface)', zIndex: 10 }}>
                                        <tr style={{ borderBottom: '1px solid #3d1f4a' }}>
                                            <th style={{ textAlign: 'left', padding: '0.5rem 0.75rem', color: '#9d6db0' }}>Tarih</th>
                                            <th style={{ textAlign: 'left', padding: '0.5rem 0.75rem', color: '#9d6db0' }}>Müşteri</th>
                                            <th style={{ textAlign: 'left', padding: '0.5rem 0.75rem', color: '#9d6db0' }}>Satın Alınan Kitaplar</th>
                                            <th style={{ textAlign: 'left', padding: '0.5rem 0.75rem', color: '#9d6db0' }}>Tutar</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {orders.slice(0, 20).map((o) => (
                                            <tr key={o.id} style={{ borderBottom: '1px solid #3d1f4a22' }}>
                                                <td style={{ padding: '0.75rem' }}>{new Date(o.createdAt).toLocaleDateString('tr-TR')}</td>
                                                <td style={{ padding: '0.75rem', fontWeight: '600', color: '#fce7f3' }}>
                                                ...
                                                <td style={{ padding: '0.75rem', color: '#f472b6', fontWeight: '800' }}>
                                        ...
                                        {orders.length === 0 && (
                                            <tr>
                                                <td colSpan={4} style={{ padding: '2rem', textAlign: 'center', color: '#9d6db0' }}>
